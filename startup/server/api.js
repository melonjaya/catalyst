...
import '../../apps/common/entities/CountryCode/api/server';
import '../../apps/common/entities/CountryCode/api/server/methods';
import '../../apps/common/entities/CountryCode/api/server/publications';
import CountryCodeTypes from '../../apps/common/entities/CountryCode/api/server/types';
import CountryCodeQueries from '../../apps/common/entities/CountryCode/api/server/queries';
import CountryCodeMutations from '../../apps/common/entities/CountryCode/api/server/mutations';
...
const schema = {
  typeDefs: gql`
    ...
    type Query {
      ...
      ## CountryCode
      detailCountryCode(_id: String): CountryCode
    ...
    type Mutation {
      ...
      updateCountryCode(inputCountryCode: CountryCodeInput): CountryCode
      removeCountryCode(_id: String!): CountryCode
      setCountryCodeStatusToActive(_id: String!, description: String): CountryCode
      setCountryCodeStatusToClosed(_id: String!, description: String): CountryCode
