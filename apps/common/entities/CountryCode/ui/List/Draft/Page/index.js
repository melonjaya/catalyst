...
import CountryCodeListDraft from '..';

import { StyledHeader } from './styles';

import { addCountryCode } from '../../../mutations.gql';

class CountryCodeListDraftPage extends React.Component {
  constructor(props) {
    super(props);
    autoBind(this);
      ...
      <React.Fragment>
        ...
        <StyledHeader className="page-header clearfix">
          <DropdownButton
            bsStyle="default"
            title={SettingsIcon}
            id="dropdownbutton_CountryCodeListDraftPage"
          >
...
CountryCodeListDraftPage.propTypes = {
