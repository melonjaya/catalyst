...
// Admin CountryCode pages
import CountryCodeDraftListPage from '../../../common/entities/CountryCode/ui/List/Draft/Page';
import CountryCodeCurrentListPage from '../../../common/entities/CountryCode/ui/List/Current/Page';
import CountryCodeHistoryListPage from '../../../common/entities/CountryCode/ui/List/History/Page';
import CountryCodeDetailPage from '../../../common/entities/CountryCode/ui/Detail/Page';
import CountryCodeEditPage from '../../../common/entities/CountryCode/ui/Edit/Page';
          ...
          <Grid>
            <Switch>
              ...
              <Authorized
                ...
                allowedRoles={['member', 'spv', 'admin']}
                path="/CountryCode"
                component={CountryCodeDraftListPage}
                setAfterLoginPath={setAfterLoginPath}
                {...props}
                {...state}
              />
              ...
              <Authorized
                exact
                allowedRoles={['member', 'spv', 'admin']}
                path="/CountryCode/current"
                component={CountryCodeCurrentListPage}
                setAfterLoginPath={setAfterLoginPath}
                {...props}
                {...state}
              />
              <Authorized
                ...
                component={CountryCodeHistoryListPage}
                setAfterLoginPath={setAfterLoginPath}
                {...props}
                {...state}
              />
              ...
              <Authorized
                exact
                allowedRoles={['member', 'spv', 'admin']}
                path="/CountryCode/:_id"
                component={CountryCodeDetailPage}
                setAfterLoginPath={setAfterLoginPath}
                {...props}
                {...state}
              />
              <Authorized
                exact
                allowedRoles={['member', 'spv', 'admin']}
                path="/CountryCode/:_id/edit"
                component={CountryCodeEditPage}
                setAfterLoginPath={setAfterLoginPath}
                {...props}
                {...state}
              />
